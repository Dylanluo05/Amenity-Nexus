...
class Phonebook(db.Model):
    ...
    servicename = db.Column(db.Text, unique=False, nullable=False)
    userID = db.Column(db.Integer, db.ForeignKey('users.userID'))

    # Constructor of a Notes object, initializes of instance variables within object
    def __init__(self, serviceid, servicename, userID):
    ...
    # returns string
    def __repr__(self):
        return "Personalization(" + str(self.id) + "," + str(self.serviceid) + "," + self.servicename + "," + str(self.userID) + ")"
